	...
	<div class="container">
		<div class="row">
			<div class="col-12 col-md">
				<center>
					<img class="mb-2" src="<?= BASEURL ?>assets/img/logo/logo.jpg" alt="" width="120" height="150">
					<small class="d-block mb-3 text-muted">Sumber Bacaan Mendunia</small>
				</center>
			</div>
			<div class="col-6 col-md">
				...
				<ul class="list-unstyled text-small">
					...
					<li><a class="text-muted" href="#">Cara Menggunakan Librarin</a></li>
				</ul>
			</div>
			<div class="col-6 col-md">
				<h5>Social Media</h5>
