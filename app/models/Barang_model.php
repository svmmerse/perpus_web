...
class Barang_model
{
    ...
    public function cariLibrariku($data)
    {
        $keyword = $data['cari'];
    ...
    public function tambah($data, $file)
    {
        ...
        (id_user , nama, id_kategori , harga , jumlah , deskripsi, created_at, foto1 , foto2 , foto3 , foto4 , foto5 , foto6) 
        VALUES 
        (:id_user , :nama , :id_kategori , :harga , :jumlah  , :deskripsi , :created_at , :foto1 , :foto2 , :foto3 , :foto4 , :foto5 , :foto6 )";
    ...
    {
        $query = "UPDATE barang SET id_kategori = :id_kategori , nama = :nama , harga = :harga , jumlah = :jumlah  , deskripsi = :deskripsi WHERE id = :id ";
